...
import creations.rimov.com.chipit.viewmodel.DirectoryViewModel
...
class DirectoryFragment
    ...
    override fun topicToWeb() {
        ...
        val directions =
            DirectoryFragmentDirections.actionDirectoryFragmentToWebFragment(
              recyclerAdapter.getSelectedId())
    ...
    override fun topicEdit(chipId: Long) {
        ...
        mainVM.setEditAction(EditorConsts.EDIT)
        findNavController().nav(
          DirectoryFragmentDirections.actionDirectoryFragmentToEditorFragment(
            EditorConsts.EDIT,
            chipId))
    }
