...
import creations.rimov.com.chipit.extension.activity
import creations.rimov.com.chipit.extension.displayImage
import creations.rimov.com.chipit.extension.gone
import creations.rimov.com.chipit.extension.visible
import creations.rimov.com.chipit.ui.custom.AudioLayout
import creations.rimov.com.chipit.ui.custom.CustomView
import creations.rimov.com.chipit.ui.custom.VideoLayout
...
class MatPrevLayout(context: Context, attrs: AttributeSet)
    : ConstraintLayout(context, attrs), CustomView<MatPrevLayout.Handler>,
    ...
    private val threadHandler: android.os.Handler by lazy {
    ...
    private val videoLayout: VideoLayout by lazy {matPreviewVideoLayout}
    private val audioLayout: AudioLayout by lazy {matPreviewAudioLayout}
    ...
    init {
        ...
        player?.apply {
            setOnPreparedListener(this@MatPrevLayout)
            setOnCompletionListener(this@MatPrevLayout)
            setOnInfoListener(this@MatPrevLayout)
            setOnErrorListener(this@MatPrevLayout)
        }
    }
