package creations.rimov.com.chipit.ui.web
...
import creations.rimov.com.chipit.ui.web.adapters.WebRecyclerAdapter
import creations.rimov.com.chipit.ui.web.adapters.viewholders.web.WebTouchCallback
...
import creations.rimov.com.chipit.fragments.WebFragmentArgs
import creations.rimov.com.chipit.fragments.WebFragmentDirections
import creations.rimov.com.chipit.ui.custom.MarginDecorator
import creations.rimov.com.chipit.viewmodel.MainViewModel
import creations.rimov.com.chipit.viewmodel.WebViewModel
...
class WebFragment
    ...
    private fun loadChipper() {
        ...
        val directions =
            WebFragmentDirections.actionWebFragmentToChipperFragment(
      ...
      motionLayout: MotionLayout?, startId: Int, endId: Int, progress: Float) {
        ...
        motionLayout?.let {
            if(startId == R.id.motionSceneWebStart && endId == R.id.motionSceneWebMax) {
                ...
                if(progress > 0.5f) mainVM.setWebTransition(true)
                else mainVM.setWebTransition(false)
            }
        }
    }
